...
(Наведи редне бројеве наредби према редоследу којим се аргументи морају навести 12435)
...
На слици можеш видети координате тачака. Тачка :math:`A` је :math:`50`
пиксела удаљена по оси :math:`x`, и :math:`150` на ниже по оси
:math:`y`, зато су координате тачке :math:`A` :math:`= (50, 150)`. На
...
да се дуж налази на средини екрана, док се :math:`x` координата простире од
