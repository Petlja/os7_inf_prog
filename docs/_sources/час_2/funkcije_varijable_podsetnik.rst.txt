Пајтон подсетник варијабле и функције
=====================================
...
.. activecode:: podsetnik_funkcije
   ...
   c = min(a,b)
   #print je takođe funkcija koja štampa argument koji joj se prosledi
   print(c)

Као и прошли пут, препоручујемо ти да током рада користиш и наш `Синтаксни подсетника за Пајтон <https://petljamediastorage.blob.core.windows.net/root/Media/Default/Help/cheatsheet.pdf>`__ ако ти икад затреба да се подсетиш ових ствари.