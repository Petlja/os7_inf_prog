...
.. mchoice:: for_isprekidana_0
    ...
    Када се помоћу петље црта испрекидана линија са цртама дужине 20 и размацима дужине 10, поечтак следеће
    црте је померен у односу на почетак претходне за
