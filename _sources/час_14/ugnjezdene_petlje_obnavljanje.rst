...
покушај да допуниш код. Ако ни то не успеш, онда погледај коначно
решење.
...
.. questionnote::
   ...
   Напиши програм који по средини екрана исцртава испрекидану линију
...
где :math:`w` означава ширину, а :math:`h` висину екрана. Дакле, те
...
.. questionnote::
   ...
   средини екрана, који се међусобно додирују, тако да је полупречник
