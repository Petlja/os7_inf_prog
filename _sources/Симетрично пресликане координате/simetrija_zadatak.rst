...
.. questionnote::
   ...
   Циљ овог задатка је да направимо програм који црта
...
.. fillintheblank:: pygame_quiz_house_2
    ...
    тачке у којој се налази врх крова (напиши их у облику уређеног пара)?
...
.. mchoice:: pygame_quiz_house_7
   :multiple_answers:
   :answer_a: Координата x горње тачке дужи једнака је координати y
              леве ивице прозора (80), а координата x доње тачке
