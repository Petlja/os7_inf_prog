...
.. questionnote::
   ...
   Напиши програм који црта концентричне кругове чији је центар у центру екрана,
...
Претходно решење има пуно мана. За почетак, тешко је откуцати оволики
...
(10, 20, 30, ..., 90, 100) и када се подсетимо да у Пајтону такво
