...
.. questionnote::
   ...
   Измените наредни програм тако да се пречаге мердевина цртају у
   петљи.
...
.. questionnote::
   ...
   распоређени ширином екрана и да се међусобно додирују.
...
.. fillintheblank:: pygame_quiz_rastojanje_kruga_od_leve_ivice
    ...
    Ако круг полупречника :math:`r` додирује леву ивицу екрана, тада
...
.. questionnote::
   ...
   распоређене вертикално средином екрана, тако да су им центри
   удаљени 50 пиксела (нацртај све кругове који се виде). Висина
   екрана се мења приликом сваког покретања програма.
