...
величина објеката на екрану. Kao што до сада знаш, увећавањем :math:`x` координате објекти се
...
пиксела, тада је његова средина удаљена 150 пиксела од леве ивице.
Ако желимо да два круга распоредимо симетрично око те средине екрана
...
:math:`(190, 80)`. Наиме, хоризонтално растојање од леве тачке до
средине треба да буде исто као хоризонтално растојање од те средине до
десне тачке. Пошто је лево растојање једнако 150 - 110 = 40, зато
десно растојање треба да буде једнако 150 + 40 = 190. Тачке су на
истој висини, па им је :math:`y` координата једнака. Веома слично се одређују
координате и када је оса симетрије било која друга хоризонтална или
вертикална права.
...
правоугаоника описаног око познате елипсе. Погледајте следећи програм и обратите пажњу на тачке :math:`Х1` и :math:`Х2`.
Такође, обратите пажњу и на горња лева темена ових правоугаоника. Да бисмо црвени правоугаоник симетрично пресликали, морамо пронаћи координате горњег левог темана плавог правоугаоника. Да бисмо то урадили, морамо прво да на основу координата тачке :math:`Х1` пронађемо координате тачке :math:`Х2`, која је подједнако удаљена од средине прозора као и тачка :math:`Х1`. Након тога, биће довољно да одузмемо ширину правоугаоника од :math:`х` координате тачке :math:`Х2` и добићемо :math:`х` координату горњег левог темена плавог плавог правоугаоника. 
...
.. questionnote::
   ...
   симетрична у односу на средину екрана.
...
Притисни дугме "Прикажи пример", па очитај координате свих
тачака. x-координате тачака на десној половини слике се не могу
...
слободан простор око правоугаоника равномерном распоређујемо на леву и
