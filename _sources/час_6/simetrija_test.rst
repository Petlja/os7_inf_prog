...
.. dragndrop:: pygame_quiz_koordinate_upari_simetricne
    ...
    Повежи тачке са њима симетричним тачкама у односу на средиште
...
.. fillintheblank:: pygame_quiz_simetricno_oko_vertikale
    ...
    средину прозора (резултат напиши у облику уређеног пара)?
...
.. fillintheblank:: pygame_quiz_simetricno_oko_horizontale
    ...
    симетрична тачки (100, 100) у односу на хоризонталну средину
