...
.. topic:: Погледај овај видео како би утврдио/утврдила све о чему смо говорили у овој лекцији.
...
* Позив функције за цртање дужи :math:`AB` у општем облику изгледа овако:
