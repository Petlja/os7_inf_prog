...
* Позив ове функције у општем облику изгледа овако ``pg.draw.line(prozor, boja, (teme1_x, teme1_y), (teme2_x, teme2_y), debljina)``.
* Дебљина линије је последњи аргумент који може бити изостављен
