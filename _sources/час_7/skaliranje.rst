...
димензије, али и да лако нацртамо више идентичних цртежа чији се
положај и величина може разликовати. За такве цртеже рећи ћемо да су
...
Можемо отићи и један корак даље и све координате израчунати само на
основу положаја једне карактеристичне тачке цртежа и његове димензије.
На пример, за карактеристичну тачку можемо узети тачку у средини, у
којој се спајају две косе линије. Тако одабране карактеристичне тачке
цртежа називају се **сидра**.
...
се може видети да се полупречник мањих кругова добија множењем већег
полупречника са :math:`\frac{5}{8}`. Такође, видимо да су центри тих
кругова на истој висини као центар великог круга и да се налазе на
