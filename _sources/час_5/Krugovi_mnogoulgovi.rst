...
.. questionnote::
   ...
   екрана. Највећи треба да буде црвен и да има полупречник 100 и да
...
Претпоставимо да се центар квадрата (тачка :math:`О`) налази у центру екрана
...
координате (на пример, координате тачке :math:`M` су :math:`(75, 75)`). На крају
...
странице квадрата. Пошто је :math:`d = a\sqrt{2}`, важи да је :math:`a
